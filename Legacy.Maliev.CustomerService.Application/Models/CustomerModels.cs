...
/// <summary>Safe compatibility identity DTO; secret Identity fields are intentionally absent.</summary>
public sealed record CustomerIdentityRequest(
    string? Id,
    string? UserName,
    string? Email,
    bool EmailConfirmed,
...
/// <summary>Safe identity response compatible with fields consumed by the legacy UIs.</summary>
...
/// <summary>Non-enumerating credential validation request.</summary>
public sealed record UserValidationRequest(string Username, string Password);

/// <summary>Result from the AuthService compatibility boundary.</summary>
public sealed record IdentityOperationResult(bool Succeeded, CustomerIdentityResponse? Identity = null, IReadOnlyList<string>? Errors = null);
